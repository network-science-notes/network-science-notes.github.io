...
$$
\begin{aligned}
\frac{d}{dt} \mathbf{x} & = -\alpha\mathbf{Lx} \,,
\end{aligned}
$$

where $\alpha$ is some constant that describes the rate of heat transfer. We've used a continuous-time description of this process, but we can still check out a few discrete-time snapshots:
